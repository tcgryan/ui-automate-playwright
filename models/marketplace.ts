...
import { BooleanApiResult } from "models";

/* tslint:disable */
/* eslint-disable */
// ReSharper disable InconsistentNaming

/** An object used for getting autocomplete event information from the client. */
export class AutocompleteImpression implements IAutocompleteImpression {
  /** Gets or sets the keyword. */
  keyword?: string | undefined;
  /** Gets or sets the algorithm. */
  algorithm?: string | undefined;
  /** Gets or sets the user's sessionId (TCG_VisitorKey). */
  sessionId!: string;
  /** Gets or sets the id (result-id) returned from the request. */
  id?: string | undefined;
  /** Gets or sets the presisted id if an impression occurred.
The autocomplete is the entrypoint for the impression funnel, so this will always be null. */
  refId?: string | undefined;
  /** Gets or sets the UserId. */
  userId?: number | undefined;
  /** Gets or sets the a collection of objects containing information about the autocomplete results. */
  results?: AutocompleteImpressionResult[] | undefined;

  constructor(data?: IAutocompleteImpression) {
      if (data) {
      ...
      if (_data) {
          ...
          if (Array.isArray(_data["results"])) {
              ...
              for (let item of _data["results"])
                  this.results!.push(AutocompleteImpressionResult.fromJS(item));
          }
      }
  }

  static fromJS(data: any): AutocompleteImpression {
      data = typeof data === 'object' ? data : {};
      let result = new AutocompleteImpression();
      result.init(data);
      return result;
  }
...
/** An object used for getting autocomplete event information from the client. */
export interface IAutocompleteImpression {
  /** Gets or sets the keyword. */
  keyword?: string | undefined;
  /** Gets or sets the algorithm. */
  algorithm?: string | undefined;
...
/** A class containing information about each result of the autocomplete impression. */
export class AutocompleteImpressionResult implements IAutocompleteImpressionResult {
  type?: AutocompleteImpressionType;
  /** Gets or sets the product name. */
  productName?: string | undefined;
  /** Gets or sets the set name. */
  setName?: string | undefined;
  /** Gets or sets the product line name. */
  productLineName?: string | undefined;

  constructor(data?: IAutocompleteImpressionResult) {
      if (data) {
          for (var property in data) {
              if (data.hasOwnProperty(property))
                  (<any>this)[property] = (<any>data)[property];
  ...
  static fromJS(data: any): AutocompleteImpressionResult {
      data = typeof data === 'object' ? data : {};
      let result = new AutocompleteImpressionResult();
      result.init(data);
      return result;
  }
...
/** A class containing information about each result of the autocomplete impression. */
export interface IAutocompleteImpressionResult {
  type?: AutocompleteImpressionType;
  /** Gets or sets the product name. */
  productName?: string | undefined;
  /** Gets or sets the set name. */
...
/** The types of autocomplete impressions. */
export enum AutocompleteImpressionType {
  _0 = 0,
  _1 = 1,
  _2 = 2,
}
...
/** An object used for getting search event information from the client. */
export class SearchImpression implements ISearchImpression {
  /** Gets or sets the Id (result-id) returned from the search request. */
  id?: string | undefined;
  /** Gets or sets the RefId that was persisted for an impression. */
  refId?: string | undefined;
  /** Gets or sets the product line being searched on, if any. */
  productLine?: string | undefined;
  /** Gets or sets the date and time of the search impression. */
  date?: Date;
  /** Gets or sets the search algorithm used. */
  algorithm?: string | undefined;
  /** Gets or sets the SessionId (TCG_VisitorKey). */
  sessionId?: string | undefined;
  /** Gets or sets the search results page. */
  page?: number;
  /** Gets or sets the total number of search results returned. */
  totalResults?: number;
  /** Gets or sets the UserId associated with the search, if any. */
  userId?: number | undefined;
  /** Gets or sets the search view used (Grid or List). */
  view?: string | undefined;
  /** Gets or sets a list of productIds returned from the search. */
  results?: number[] | undefined;
  /** Gets or sets the keyword used to search. */
  keyword?: string | undefined;
  /** Gets or sets the field used to order the search results. */
  orderBy?: string | undefined;
  /** Gets or sets a value indicating whether the results were ordered by descending. */
  orderDesc?: boolean;

  constructor(data?: ISearchImpression) {
      if (data) {
          for (var property in data) {
              if (data.hasOwnProperty(property))
                  (<any>this)[property] = (<any>data)[property];
  ...
  init(_data?: any) {
      if (_data) {
          ...
          this.orderDesc = _data["orderDesc"];
      }
  }

  static fromJS(data: any): SearchImpression {
      data = typeof data === 'object' ? data : {};
      let result = new SearchImpression();
      result.init(data);
      return result;
  }
...
/** An object used for getting search event information from the client. */
export interface ISearchImpression {
  /** Gets or sets the Id (result-id) returned from the search request. */
  id?: string | undefined;
  /** Gets or sets the RefId that was persisted for an impression. */
  refId?: string | undefined;
